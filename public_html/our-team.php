                        ...
                        <div class="ttm-box-col-wrapper col-lg-4 col-sm-6 col-md-4 col-xs-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-team style1">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid" src="./../uploads/<?php echo   $result->image ?>" alt="image">
                                </div>
                                <div class="featured-content featured-content-team">
                                    <div class="featured-title">
                                        <h3><a href="./../faculty-details.php?id=<?php echo   $result->id ?>&name=<?php echo $result->slug ?>"><?php echo   $result->name ?> <?php echo   $result->thumbname ?></a></h3>
                                    </div>
                                    <div class="team-position"><?php echo   $result->designation ?></div>
                                    <b><?php echo   $result->department ?></b>
