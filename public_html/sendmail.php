...
<body>
    ...
    if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
        ...
        if ($responseData->success) {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'mescollegekmgm@gmail.com'; //SENDER MAIL ID
            $mail->Password = 'vkrujsnmndwhmvba'; //PASSWORD
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;
            //Recipients
            $mail->setFrom('mescollegekmgm@gmail.com', 'Ship Tech Web Site'); //SENDER MAIL ID
            $mail->addAddress('mescollegekmgm@gmail.com'); //RECIVER MAIL ID
            //Content
            $mail->isHTML(true);
