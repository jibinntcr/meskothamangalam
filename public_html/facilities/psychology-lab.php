                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">Psychology Lab</h2>
                            </div>
                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/ps1.jpg">
                                    </span>
                                    <span>
                                        <img src="../images_template/facilities/ps3.jpg">
                                    </span>
                                </div><br>
                                <p>The Psychology Lab ensures students with a promising and interesting area that
                                    introduces them to the scientific field of practical assessment, evaluation, and
                                    psychological testing. The lab provides various psychological tests, modern
                                    cognitive assessment techniques, and various experimental apparatus for the
                                    students.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active "><a href="./psychology-lab.php">Psychology Lab</a></li>
