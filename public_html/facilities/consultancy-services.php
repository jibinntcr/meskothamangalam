                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/CONSULTANCY SERVICE.jpg">
                                    </span>
                                    <br>
                                </div>
                                <p>
                                    The BCA Association CyberNauts offers consultancy services within the college,
                                    providing assistance and guidance on various topics related to computer science and
                                    technology.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active "><a href="./consultancy-services.php">Consultancy Services</a>
                                    </li>
