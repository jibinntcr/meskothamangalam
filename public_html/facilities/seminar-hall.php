                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/SEMINAR HALL.jpg">
                                    </span>
                                    <br>
                                </div>
                                <p> A spacious seminar halls with ample seating capacity are available for conducting
                                    various activities. These halls are equipped with all the latest state-of-the-art
                                    facilities.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active "><a href="./seminar-hall.php">Seminar Hall</a></li>
