                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/canteen.jpg">
                                    </span>
                                    <br>
                                </div>
                                <p>The College Cafeteria provides good quality food at economic rates for the staff and
                                    students of the college. Utmost importance is given to ensure that the food is
                                    prepared hygienically and all principles of food sanitation are followed strictly.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active "><a href="./cafeteria.php">Cafeteria</a></li>
