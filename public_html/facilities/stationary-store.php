                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">Stationary store</h2>
                            </div>
                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/stationary.jpeg">
                                    </span>
                                    <br>
                                </div>
                                <p> Nestled in a bustling corner of the college campus, the stationary store beckons
                                    students with vibrant displays of academic essentials and creative inspirations. Its
                                    shelves offer a wide array of supplies, from pens to textbooks, catering to every
                                    academic need. A warm and helpful cashier stands ready to assist, making it a
                                    vibrant hub where ideas flourish and academic dreams take flight.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active "><a href="./stationary-store.php">Stationary store</a></li>
