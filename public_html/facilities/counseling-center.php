                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">Counselling Center</h2>
                            </div>
                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/counselling_1.jpg">
                                    </span>
                                    <br>
                                </div>
                                <p>
                                    The Counselling Center offers confidential support for students, providing counseling
                                    sessions and resources to address personal, academic, and emotional concerns.
                        ...
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active "><a href="./counseling-center.php">Counselling Center</a></li>
