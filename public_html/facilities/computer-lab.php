                    ...
                    <div class="row">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Facilities in MES College Kothamangalam</h3>
                                        <h2 class="title">Computer Lab</h2>
                                    </div>
                                ...
                                <div class="facilities-images">
                                    <span>
                                        <img src="../images_template/facilities/c_lab1.jpg">
                                    </span>
                                    <span>
                                        <img src="../images_template/facilities/c_lab2.jpg">
                                    </span>
                                </div><br>
                                <p>The Computer Department oversees a sophisticated instructional computer lab featuring
                                    25 interconnected computers linked to the campus network. Each workstation is
                                    equipped with LCD projectors, an audio system, printers, scanners, and UPS backup.
                                    Ubuntu and Windows are the prevailing operating systems across all machines, with
                                    licenses for Windows Dreamspark Standard and Premium packs available. Additionally,
                                    broadband WiFi connectivity is extended to faculty members and undergraduate
                                    students.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    <li class="active "><a href="./computer-lab.php">Computer Lab</a></li>
                                    ...
                                    <li><a href="./counseling-center.php">Counselling Center</a></li>
                                    <li><a href="./consultancy-services.php">Consultancy Services</a>
                                    </li>
                                    <li><a href="./college-bus.php">College Bus</a>
                                    </li>
                                </ul>
                            </aside>
                        </div>
