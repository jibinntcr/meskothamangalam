                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-8 content-area">
                            <!-- post -->
                            <div class="pb-55 res-991-pb-0 res-991-pr-0">
                                <!-- section title -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-20">
                                        <div class="featured-thumbnail ml-5 pb-55">
                                            <img class="img-fluid"
                                    ...
                                    <div class="col-lg-6 mt-20">
                                        <div class="mt_5 pb-55 res-991-pb-40">
                                            <h4 class="font-weight-600 ">Treasurer's Message</h4>

                                            <div class="pb-5 pt-5 res-991-p-0">
                                                <p>Dear Students, Faculty, and Friends of MES College Kothamangalam,</p>
                                                <p>As the Treasurer of MES College Kothamangalam, I am honored to welcome you to an institution committed to integrity, excellence, and financial stewardship. We prioritize investments in state-of-the-art facilities, cutting-edge technology, and comprehensive support services to create an optimal learning environment. Our scholarship programs and financial literacy initiatives ensure education is accessible and students are well-prepared for their futures.</p>
                                                <p>Collaboration with alumni, donors, and industry partners secures resources that enhance educational opportunities. We remain dedicated to maintaining MES College Kothamangalam as a beacon of academic excellence and innovation. Thank you for your continued support and trust.</p>
                                            </div>
                                    ...
                                    <div class="featured-icon-box icon-align-before-content pt-5 res-991-pt-0 ml-20">

                                        <div class="featured-content pl-30">
                                            <div class="featured-title">
                                                <div class="d-flex align-items-center">
                                                    <h4 class="mb-0 mr-2 figure-img">—</h4>
                                                    <h3 class="mb-0 font-weight-600 fs-22"> M J Abdul Jabbar
                                                    </h3>
                                                </div>
                                                <h3>Treasurer, MES College Kothamangalam</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <ul class="ml-5 mt-10 ">
                                            <li><a href="#">Management</a>
                                                <ul class="ml-5 mt-10 ">
                                                    ...
                                                    <li class="active "><a href="./treasurer.php">Treasurer</a></li>
