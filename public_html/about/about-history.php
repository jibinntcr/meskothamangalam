...
<body>
    ...
    <div class="page">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>ABOUT MES College Kothamangalam</h3>
                                        <h2 class="title">History</h2>
                                    </div>
                                </div><!-- section title end -->
                                <p>MES College Kothamangalam is a key institution under the umbrella of the Muslim
                                    Educational Society (MES), established to broaden access to quality education,
                                    particularly for underprivileged communities. The college reflects MES's commitment
                                    to educational, social, cultural, and economic advancement, offering undergraduate
                                    programs that are attuned to the demands of the job market, such as Computer
                                    Applications (BCA), B.Com Co-operation, and BSc Psychology.
                                    Located in Kerala, the college exemplifies MES’s mission to democratise education
                                    and ensure inclusivity. The strategic management and governance of the college are
                                    influenced by MES's principles, emphasising equity and inclusion. Notably, the
                                    college has facilitated significant enrollment of girls and minority students,
                                    validating its institutional commitment to these values.
                                    As part of a larger network of institutions led by MES, MES College Kothamangalam
                                    continues to foster an environment of learning and growth, ensuring that education
                                    reaches every segment of society, thereby contributing to the reduction of
                                    illiteracy and poverty in the region.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    <li class="active"><a href="./about-history.php">History</a></li>
                                    ...
                                    <li>
                                        <a href="#" class="">Organisation</a>
                                        <ul class="ml-5 mt-10 ">
                                            <li><a href="#">Management</a>
                                                <ul class="ml-5 mt-10 ">
                                                    <!-- <li>
                                                        <a href="./managing-committee.php">Managing Committee</a>
                                                    </li> -->
        ...
        <?php include('../partials/inner-footer.php') ?>
