                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-20">
                                        <div class="featured-thumbnail ml-5 pb-55">
                                            <img class="img-fluid"
                                                src="../images_template/managing-committee.php/chairman.jpg"
                                                alt="image">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mt-20">
                                        <div class="mt_5 pb-55 res-991-pb-40">
                                            <h4 class="font-weight-600 ">Chairman's Message</h4>

                                            <div class="pb-5 pt-5 res-991-p-0">
                                                <p>Dear Students and Esteemed Members of the MES College Kothamangalam Community,</p>
                                                <p>As Chairman of MES College Kothamangalam, I am proud to address you. Our college exemplifies the transformative power of education. We are dedicated to providing an academically rigorous and enriching experience, encouraging critical thinking, creativity, and a global perspective. Our diverse programs and forward-thinking approach prepare students to excel in their fields, supported by our expert faculty.</p>
                                                <p>Thank you for being part of MES College Kothamangalam. Together, let us achieve greatness and contribute to a better world.</p>
                                            </div>
                                        ...
                                        <div class="featured-content pl-30">
                                            <div class="featured-title">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h3 class="mb-0 font-weight-600 fs-22"> Adv Abumoideen
                                                    </h3>
                                                </div>
                                                <h3>Chairman, MES College Kothamangalam</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <ul class="ml-5 mt-10 ">
                                            <li><a href="#">Management</a>
                                                <ul class="ml-5 mt-10 ">
                                                    ...
                                                    <li class="active"><a href="./chairman.php">Chairman</a></li>
