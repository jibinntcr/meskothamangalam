                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-8 content-area">
                            ...
                            <div class="pb-55 pr-20 res-991-pb-0 res-991-pr-0">
                                ...
                                <h2 class="fs-24">VISION</h2>
                                <h3 class="fs-18  mb-40">Excellence, Integrity and
                                    Perseverance.
                                </h3>


                                <h2 class="fs-24">MISSION</h2>
                                <h4 class="fs-18  mb-20 justify-para">To build up a community with
                                    character and
                                    veracity by imparting knowledge which fosters skills and values and
                                    prepare them
                                    to excel and develop into ethically strong and morally
                        ...
                        <div
                            ...
                            <aside class="widget widget-Categories with-title">
                                ...
                                <ul class="sidebar">
                                    ...
                                    <li class="active"><a href="./vision-and-mission.html">VISION AND MISSION</a></li>
