                        ...
                        <div
                            ...
                            <aside class="widget widget-recent-post with-title">
                                ...
                                <ul class="widget-post ttm-recent-post-list">
                                    <?php
                                        $sql = "SELECT * from news  WHERE status='1' ORDER BY `date` DESC LIMIT 3";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                    ...
                                    ?>
                                    <li>
                                        <a href="blog-single-news.php"><img class="img-fluid"
                                        ...
                                        <a href="blog-single-news.php?id=<?php echo   $result->id ?>&slug=<?php echo $result->slug ?>"><?php $title =  substr($result->title, 0, 50);
                                                                            echo $title ?></a>
                                    </li>
                                    <?php   }
                                        }
