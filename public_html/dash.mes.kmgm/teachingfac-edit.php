...
?>
    ...
    <head>
        ...
        <title>Edit Faculty | MES Admin</title>
        <!-- plugins:css -->
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="department" name="department" value="<?php echo ($userArr[0]->department); ?>">
                                            </div>
                                            <div class="form-group">
